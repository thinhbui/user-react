                ...
                <div className="profile">
                    ...
                    <div style={{ display: 'flex', flex: 4, justifyContent: 'flex-start', height: '100%', flexDirection: 'column', marginTop: 20 }}>
                        <div style={{ display: 'flex', justifyContent: 'flex-start', flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <Link to="/setting">
                                <button
                                    ...
                                    Chỉnh sửa thông tin cá nhân</button></Link>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'flex-start', flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <Link to="/document">
                                <div style={{ marginLeft: 30, cursor: 'pointer', color:'black' }} onClick={() => { this.setState({ document: true }) }}><span>2</span><span> tài liệu</span></div>
                            </Link>
